      ...
      <div class="account-overview">
        <div class="top-of-user-overview">
          <div class="pagination-and-amount">
            ...
            <div class="dropdown">
              <select v-model="itemsPerPage" @change="updateDisplayedUsers" class="items-per-page-dropdown">
        ...
        <table class="user-table">
          <thead>
            <tr>
              <th class="user-table-head"><h2>user.UserID</h2></th>
        ...
        <button id="create-user-button" @click="$router.push('/users/create')">Click here</button>
